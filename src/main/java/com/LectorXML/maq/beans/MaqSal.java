...
@Entity
@Table(name = "Maq_Sal")
public class MaqSal implements Serializable {
   ...
   // @XStreamConverter(DateConverter.class)
    ...
    private String Importe_Coinin_Promo;
    ...
    public String getImporte_Coinin_Promo() {
        return Importe_Coinin_Promo;
    }

    public void setImporte_Coinin_Promo(String Importe_Coinin_Promo) {
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.Numero_Maquina);
        return hash;
    }
